//Write a program in c to store information about marks obtained in "m" subject by a number of students using Dynamic memory Allocation technique
    ...
    if (marks == NULL) {
        ...
        do {
            ...
            if (ans == 1) {
                ...
                marks = (int*)realloc(
                    marks,
                    (index + 1)* sizeof(int)); // Dynamically reallocate
